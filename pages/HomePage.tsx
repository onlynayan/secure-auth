  ...
  return (
    <div className="w-full flex flex-col min-h-full">
      <div className="flex-1 w-full max-w-7xl mx-auto p-6 flex flex-col">
        {/* Header Banner */}
        <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden mb-6 shadow-2xl shrink-0">
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex-1">
              ...
              <div className="flex gap-4">
                <button 
                  ...
                  className="bg-white text-slate-950 px-6 py-3 rounded-xl font-black text-sm flex items-center gap-2 hover:bg-slate-200 transition-all shadow-xl active:scale-95"
                >
            ...
            <div className="w-full md:w-64 bg-slate-950/50 backdrop-blur-md border border-slate-800 p-6 rounded-3xl shrink-0">
              ...
              <p className="text-slate-500 text-[11px] leading-tight min-h-[30px]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 shrink-0">
          {[
            ...
            <div key={i} className="bg-slate-900 border border-slate-800 p-4 rounded-2xl flex items-center gap-4 hover:border-slate-700 transition-colors group">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          <div className="bg-gradient-to-br from-slate-900 to-indigo-950 p-8 rounded-[2rem] border border-white/5 relative group flex flex-col justify-center min-h-[200px]">
          ...
          <div className="bg-slate-900 p-8 rounded-[2rem] border border-slate-800 relative group flex flex-col justify-center min-h-[200px]">
        ...
        {/* Footer */}
        <footer className="mt-auto pt-6 pb-6 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center text-slate-600 gap-4 shrink-0">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-indigo-500 animate-pulse" />
            <span className="text-[10px] font-black uppercase tracking-widest">Core Security Engine v2.4</span>
          </div>
